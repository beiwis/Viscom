...
#                      My Functions                      #
##########################################################
def plotEpipolarLine(ax, F, x1, img_shape):
    """
    Plot the epipolar line in image 2 given a point in image 1.
    -input:
        ax: axis handle
    ...
    # Define the line endpoints in image 2
    x2_0 = np.array([0, -l2[2] / l2[1]])
    x2_1 = np.array([img_shape[1], -(l2[2] + l2[0] * img_shape[1]) / l2[1]])
    
    # Plot the epipolar line in 2D
    ax.plot([x2_0[0], x2_1[0]], [x2_0[1], x2_1[1]], 'r-')
